...
/**
 * Table primitives. The wrapper scrolls horizontally rather than the page, so
 * narrow screens keep the surrounding layout intact.
 */
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-10 px-4 text-left align-middle text-sm font-medium text-muted-foreground whitespace-nowrap',
      className,
    )}
    {...props}
  />
